...
* [Heaps](https://github.com/HeapsIO/heaps) ⭐ 3,499 | 🐛 185 | 🌐 Haxe | 📅 2026-09-02 - High Performance Game Framework (`Web`, `Mobile`, `Desktop`, `Consoles`).
...
* [OpenFL](https://github.com/openfl/openfl) ⭐ 2,153 | 🐛 339 | 🌐 Haxe | 📅 2026-09-02 - Interactive game and app development library (`Web`, `Mobile`, `Desktop`, `Consoles`).
...
* [polymod](https://github.com/larsiusprime/polymod) ⭐ 210 | 🐛 48 | 🌐 Haxe | 📅 2026-09-01 - An atomic modding framework for games/apps.
