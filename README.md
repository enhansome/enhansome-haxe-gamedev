...
* [Heaps](https://github.com/HeapsIO/heaps) ⭐ 3,499 | 🐛 184 | 🌐 Haxe | 📅 2026-09-07 - High Performance Game Framework (`Web`, `Mobile`, `Desktop`, `Consoles`).
* [Armory (Kha)](https://github.com/armory3d/armory) ⭐ 3,318 | 🐛 398 | 🌐 C++ | 📅 2026-07-16 - An open-source 3D game engine with full Blender integration (`Web`, `Mobile`, `Desktop`, `Consoles`).
* [HaxeFlixel (OpenFL)](https://github.com/HaxeFlixel/flixel) ⭐ 2,204 | 🐛 304 | 🌐 Haxe | 📅 2026-08-23 - Free, cross-platform 2D game engine powered by OpenFL (`Web`, `Mobile`, `Desktop`, `Consoles`).
* [OpenFL](https://github.com/openfl/openfl) ⭐ 2,153 | 🐛 338 | 🌐 Haxe | 📅 2026-09-04 - Interactive game and app development library (`Web`, `Mobile`, `Desktop`, `Consoles`).
...
* [Away3D](https://github.com/openfl/away3d) ⭐ 229 | 🐛 28 | 🌐 Haxe | 📅 2026-07-27 - An open source, real-time 3D engine for OpenFL (`Web`, `Mobile`, `Desktop`).
...
* [Lime](https://github.com/openfl/lime) ⭐ 848 | 🐛 214 | 🌐 JavaScript | 📅 2026-09-05 - A flexible, lightweight layer for Haxe cross-platform developers (`Web`, `Mobile`, `Desktop`).
