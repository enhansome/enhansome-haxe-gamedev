...
* [Heaps](https://github.com/HeapsIO/heaps) ⭐ 3,500 | 🐛 184 | 🌐 Haxe | 📅 2026-09-07 - High Performance Game Framework (`Web`, `Mobile`, `Desktop`, `Consoles`).
* [Armory (Kha)](https://github.com/armory3d/armory) ⭐ 3,320 | 🐛 398 | 🌐 C++ | 📅 2026-07-16 - An open-source 3D game engine with full Blender integration (`Web`, `Mobile`, `Desktop`, `Consoles`).
...
* [hxbit](https://github.com/ncannasse/hxbit) ⭐ 166 | 🐛 11 | 🌐 Haxe | 📅 2026-08-31 - A binary serialization and network synchronization library.
...
* [polymod](https://github.com/larsiusprime/polymod) ⭐ 211 | 🐛 46 | 🌐 Haxe | 📅 2026-09-05 - An atomic modding framework for games/apps.
