...
* [Armory (Kha)](https://github.com/armory3d/armory) ⭐ 3,328 | 🐛 397 | 🌐 C++ | 📅 2026-09-09 - An open-source 3D game engine with full Blender integration (`Web`, `Mobile`, `Desktop`, `Consoles`).
...
* [polymod](https://github.com/larsiusprime/polymod) ⭐ 211 | 🐛 47 | 🌐 Haxe | 📅 2026-09-08 - An atomic modding framework for games/apps.
